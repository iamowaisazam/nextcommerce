          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h3 className="bread-crumb-title">{tag.title}</h3>
...
export async function getServerSideProps({query}) {
    ...
    const {slug} = query;
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/items/tag/${slug}`);  
